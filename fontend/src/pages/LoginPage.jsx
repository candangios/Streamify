    ...
    <div className='h-screen flex items-center justify-center p-4 sm:p-6 md:p-8' data-theme='forest'>
      <div className='border border-primary/25 flex flex-col lg:flex-row w-full max-w-5xl mx-auto bg-base-100 rounded-xl shadow-lg overflow-hidden'>
        ...
        <div className='w-full  lg:w-1/2 p-4 sm:p-8 flex flex-col'>
          {/* logo */}
          <div className='mb-4 flex items-center justify-start gap-y-2'>
          ...
          <div className='w-full'>
            <form onSubmit={handleLogin}>
              <div className='space-y-4'>
                ...
                <p className='text-sm opacity-70'>Sign in to your account to comtinue your language journey</p>
              </div>
        ...
        <div className='hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center'>
          <div className='max-w-md p-8'>
            ...
            <div className=' text-center space-y-3 mt-6'>
              ...
              <p className=' opacity-70'> Practive converstations, make friends, and improve your language skills together.</p>
            </div>
          </div>
